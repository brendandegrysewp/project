...
class StopAndWaitServer:
    ...
    ############################################################################
    # Step 5: Figure out a way to randomly not respond to some packets to test #
    # you are correctly handling a timeout   (random.random might help)        #
    ############################################################################
    ...
    def start(self):
        ...
        try:
            ...
            while True:
                ...
                """
                You can choose to randomly not send a response to make sure
                your client handles that case accordingly.
                """
